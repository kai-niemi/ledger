...
fn_failcheck roachprod put ${CLUSTER}:${clientnodes} ../target/ledger.jar ledger.jar
fn_failcheck roachprod put ${CLUSTER}:${clientnodes} ../config/application-default.yml config/
fn_failcheck roachprod put ${CLUSTER}:${clientnodes} ../config/application-test.yml config/
