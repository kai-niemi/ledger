...
/**
 * Represents a monetary transaction labelled 'transfer' to separate it from database transactions.
 */
@Entity
@Table(name = "transfer")
@DynamicInsert
public class Transfer extends AbstractEntity<UUID> implements EventAggregate<UUID> {
    @Id
    ...
    public Transfer addItems(List<TransferItem> items) {
    ...
    public static final class Builder {
        ...
        public Transfer build() {
            return new Transfer(id, city, transferType, bookingDate, transferDate);
        }
    }
}
