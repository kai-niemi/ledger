 ...
 * must equal zero.
 * <p>
 * A request must have at least two items, called transfer legs, a city name
 * and a client generated reference ID for idempotency and a transaction type.
 * <p>
 * Each transfer leg points to a single account by id and city, and includes
 * an amount that is either positive (credit) or negative (debit).
 * <p>
 * It is possible to have legs with different account regions and currencies,
 * as long as the total balance for entries with the same currency is zero.
 */
...
public class TransferRequest {
    ...
    public static class AccountItemBuilder {
        ...
        public AccountItemBuilder withCity(String city) {
